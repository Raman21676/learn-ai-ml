...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalChallenges = level1.challenges.length + level2.challenges.length + level3.challenges.length + level4.challenges.length;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Master AI-ML with $totalChallenges challenges and 1050+ questions.',
                  ...
                  _buildFeatureTile(
                    ...
                    subtitle: '1050+ questions across 21 challenges',
                  ),
                  _buildFeatureTile(
                    context,
